...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public void handleStatusUpdate(byte id) {
        switch (id) {
            case 9 -> onItemUseFinish();
            case 23 -> hasReducedDebug = false;
            case 22 -> hasReducedDebug = true;
    ...
    /**
     * Handles updating while being ridden by fan entity
     */
        ...
        if (targetEntity.canAttackWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (!Minecraft.getMinecraft().thePlayer.isInvisibleToPlayer(this)) {
    ...
    private void func_175139_a(EnumFacing p_175139_1_) {
        ...
        switch (p_175139_1_) {
            case SOUTH -> renderOffsetZ = -1.8F;
            case NORTH -> renderOffsetZ = 1.8F;
            case WEST -> renderOffsetX = 1.8F;
            case EAST -> renderOffsetX = -1.8F;
        }
    }
