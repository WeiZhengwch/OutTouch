...
public class Chunk {
    ...
    public Block getBlock(final int x, final int y, final int z) {
        try {
            ...
            crashreportcategory.addCrashSectionCallable("Location", () -> CrashReportCategory.getCoordinateInfo(new BlockPos(xPosition * 16 + x, y, zPosition * 16 + z)));
    ...
    public void addEntity(Entity entityIn) {
        ...
        if (i != xPosition || j != zPosition) {
            logger.warn("Wrong location! (" + i + ", " + j + ") should be (" + xPosition + ", " + zPosition + "), " + entityIn, new Object[]{entityIn});
            entityIn.setDead();
        }
    ...
    public void enqueueRelightChecks() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            for (int i1 = 0; i1 < 16; ++i1) {
                ...
                if (storageArrays[j] == null && flag || storageArrays[j] != null && storageArrays[j].getBlockByExtId(k, i1, l).getMaterial() == Material.air) {
