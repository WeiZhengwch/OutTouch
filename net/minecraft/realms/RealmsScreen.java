...
public class RealmsScreen {
    ...
    public void drawString(String p_drawString_1_, int p_drawString_2_, int p_drawString_3_, int p_drawString_4_, boolean p_drawString_5_) {
        proxy.func_154322_b(p_drawString_1_, p_drawString_2_, p_drawString_3_, p_drawString_4_, false);
    }
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        for (int i = 0; i < proxy.func_154320_j().size(); ++i) {
            proxy.func_154320_j().get(i).render(p_render_1_, p_render_2_);
        }
    }
