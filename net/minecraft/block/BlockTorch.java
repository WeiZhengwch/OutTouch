...
public class BlockTorch extends Block {
    ...
    public IBlockState getStateFromMeta(int meta) {
        ...
        switch (meta) {
            case 1 -> iblockstate = iblockstate.withProperty(FACING, EnumFacing.EAST);
            case 2 -> iblockstate = iblockstate.withProperty(FACING, EnumFacing.WEST);
            case 3 -> iblockstate = iblockstate.withProperty(FACING, EnumFacing.SOUTH);
            case 4 -> iblockstate = iblockstate.withProperty(FACING, EnumFacing.NORTH);
            case 5 -> iblockstate = iblockstate.withProperty(FACING, EnumFacing.UP);
        }
