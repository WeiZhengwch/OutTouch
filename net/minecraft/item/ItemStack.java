...
public final class ItemStack {
    ...
    private final Block canDestroyCacheBlock;
    private final boolean canDestroyCacheResult;
    private final Block canPlaceOnCacheBlock;
    ...
    public boolean isOnItemFrame() {
        return itemFrame != null && itemFrames.getIfPresent(this) != null;
    }
    ...
    public EntityItemFrame getItemFrame() {
        return itemFrames == null ? null : itemFrames.getIfPresent(this);
    }
    ...
    public void setItemFrame(EntityItemFrame frame) {
        ...
        if (frame == null) {
            itemFrames.invalidate(this);
        } else {
            itemFrames.put(this, frame);
        }
    }
    ...
    public boolean canDestroy(Block blockIn) {
        ...
        if (destroyInfo != null && destroyInfo.getLeft() == blockIn) {
            return destroyInfo.getRight().booleanValue();
        }
        if (hasTagCompound() && stackTagCompound.hasKey("CanDestroy", 9)) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                ...
                if (block == blockIn) {
                    canDestroyCache.put(this, Pair.of(blockIn, true));
                    return true;
                }
            }
        }
        canDestroyCache.put(this, Pair.of(blockIn, false));
        return false;
    }
    ...
    public boolean canPlaceOn(Block blockIn) {
        ...
        if (hasTagCompound() && stackTagCompound.hasKey("CanPlaceOn", 9)) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                Block block = Block.getBlockFromName(nbttaglist.getStringTagAt(i));
                if (block == blockIn) {
                    canPlaceCache.put(this, Pair.of(blockIn, true));
                    return true;
                }
            }
        }
        canPlaceCache.put(this, Pair.of(blockIn, false));
        return false;
    }
}
