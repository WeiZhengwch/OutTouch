...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        if (s != null) {
            try {
                proxy = new Proxy(Type.SOCKS, new InetSocketAddress(s, optionset.<Integer>valueOf(optionspec6)));
        ...
        int i = optionset.<Integer>valueOf(optionspec13);
        int j = optionset.<Integer>valueOf(optionspec14);
