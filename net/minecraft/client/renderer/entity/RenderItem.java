...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public RenderItem(TextureManager textureManager, ModelManager modelManager) {
        ...
        if (Reflector.ItemModelMesherForge_Constructor.exists()) {
            itemModelMesher = (ItemModelMesher) Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, new Object[]{modelManager});
        } else {
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
        if (stack != null) {
            ...
            if (ReflectorForge.isItemDamaged(stack)) {
                ...
                Tessellator tessellator = Tessellator.getInstance();
                WorldRenderer worldrenderer = tessellator.getWorldRenderer();
                draw(worldrenderer, xPosition + 2, yPosition + 13, 13, 2, 0, 0, 0);
                draw(worldrenderer, xPosition + 2, yPosition + 13, 12, 1, (255 - i) / 4, 64, 0);
                int j = 255 - i;
                int k = i;
                int l = 0;
                ...
                draw(worldrenderer, xPosition + 2, yPosition + 13, j1, 1, j, k, l);
                GlStateManager.enableBlend();
                GlStateManager.enableAlpha();
