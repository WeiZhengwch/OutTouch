...
public class RenderPainting extends Render<EntityPainting> {
    ...
    private void setLightmap(EntityPainting painting, float p_77008_2_, float p_77008_3_) {
        ...
        switch (enumfacing) {
            case NORTH -> i = MathHelper.floor_double(painting.posX + (double) (p_77008_2_ / 16.0F));
            case WEST -> k = MathHelper.floor_double(painting.posZ - (double) (p_77008_2_ / 16.0F));
            case SOUTH -> i = MathHelper.floor_double(painting.posX - (double) (p_77008_2_ / 16.0F));
            case EAST -> k = MathHelper.floor_double(painting.posZ + (double) (p_77008_2_ / 16.0F));
        }
