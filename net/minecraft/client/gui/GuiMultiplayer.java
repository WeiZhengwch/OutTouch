...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void createButtons() {
        buttonList.add(btnEditServer = new GuiButton(5, width / 2 - 154, height - 28, 70, 20, I18n.format("selectServer.edit")));
        ...
        buttonList.add(new GuiButton(6, width / 2 + 4, height - 28, 70, 20, I18n.format("selectServer.refresh")));
