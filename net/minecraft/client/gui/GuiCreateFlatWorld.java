...
public class GuiCreateFlatWorld extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawRect(0, height, width, height - 56, Integer.MIN_VALUE);
        drawGradientRect(0, height - 64, width, height - 56, 0, Integer.MIN_VALUE);
    ...
    class Details extends GuiSlot {
        ...
        private void func_148226_e(int p_148226_1_, int p_148226_2_) {
            func_148224_c(p_148226_1_, p_148226_2_);
        }
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_) {
            ...
            worldrenderer.pos(p_148224_1_, p_148224_2_ + 18, zLevel).tex((float) (0) * 0.0078125F, (float) (18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148224_1_ + 18, p_148224_2_ + 18, zLevel).tex((float) (18) * 0.0078125F, (float) (18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148224_1_ + 18, p_148224_2_, zLevel).tex((float) (18) * 0.0078125F, (float) (0) * 0.0078125F).endVertex();
