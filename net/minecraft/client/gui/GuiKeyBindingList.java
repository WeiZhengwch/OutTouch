...
public class GuiKeyBindingList extends GuiListExtended {
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            mc.fontRendererObj.drawStringWithShadow(labelText, mc.currentScreen.width / 2 - labelWidth / 2, y + slotHeight - mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            ...
            mc.fontRendererObj.drawStringWithShadow(keyDesc, x + 90 - maxListLabelWidth, y + slotHeight / 2 - mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);
