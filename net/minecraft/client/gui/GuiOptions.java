...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        if (mc.theWorld != null) {
            ...
            GuiOptionButton guioptionbutton1 = new GuiOptionButton(GameSettings.Options.REALMS_NOTIFICATIONS.returnEnumOrdinal(), width / 2 - 155 + i % 2 * 160, height / 6 - 12 + 24 * (i >> 1), GameSettings.Options.REALMS_NOTIFICATIONS, game_settings_1.getKeyBinding(GameSettings.Options.REALMS_NOTIFICATIONS));
        ...
        buttonList.add(new GuiButton(119, width / 2 - 100, height / 6 + 14, I18n.format("OutTouch Setting")));
    }
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            ...
            if (button.id == 119) {
                mc.displayGuiScreen(new ClientSetting(this, game_settings_1));
            }
        }
    }
