    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            switch (button.id) {
                ...
                case 1 -> displaySlot = generalStats;
                case 3 -> displaySlot = itemStats;
                case 2 -> displaySlot = blockStats;
                case 4 -> displaySlot = mobStats;
                default -> displaySlot.actionPerformed(button);
            }
        }
    }
