...
public class GuiFlatPresets extends GuiScreen {
    ...
    class ListSlot extends GuiSlot {
        ...
        private void func_148173_e(int p_148173_1_, int p_148173_2_) {
            func_148171_c(p_148173_1_, p_148173_2_);
        }
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_) {
            ...
            worldrenderer.pos(p_148171_1_ + 0, p_148171_2_ + 18, zLevel).tex((float) (0 + 0) * 0.0078125F, (float) (0 + 18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148171_1_ + 18, p_148171_2_ + 18, zLevel).tex((float) (0 + 18) * 0.0078125F, (float) (0 + 18) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148171_1_ + 18, p_148171_2_ + 0, zLevel).tex((float) (0 + 18) * 0.0078125F, (float) (0 + 0) * 0.0078125F).endVertex();
            worldrenderer.pos(p_148171_1_ + 0, p_148171_2_ + 0, zLevel).tex((float) (0 + 0) * 0.0078125F, (float) (0 + 0) * 0.0078125F).endVertex();
            tessellator.draw();
        }
