...
public class GuiControls extends GuiScreen {
    private static final GameSettings.Options[] optionsArr = new GameSettings.Options[]{GameSettings.Options.INVERT_MOUSE, GameSettings.Options.SENSITIVITY, GameSettings.Options.TOUCHSCREEN, GameSettings.Options.CLIENT_MISC_RAWMOUSEINPUT};
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        } else if (button.id < 200 && button instanceof GuiOptionButton) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawRect(0, 0, width, 63, Integer.MIN_VALUE);
        drawGradientRect(0, 63, width, 75, Integer.MIN_VALUE, 0);
