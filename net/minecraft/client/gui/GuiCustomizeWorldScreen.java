...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    public void func_175321_a(int p_175321_1_, boolean p_175321_2_) {
        switch (p_175321_1_) {
            case 148 -> field_175336_F.useCaves = p_175321_2_;
            case 149 -> field_175336_F.useDungeons = p_175321_2_;
            case 150 -> field_175336_F.useStrongholds = p_175321_2_;
            case 151 -> field_175336_F.useVillages = p_175321_2_;
            case 152 -> field_175336_F.useMineShafts = p_175321_2_;
            case 153 -> field_175336_F.useTemples = p_175321_2_;
            case 154 -> field_175336_F.useRavines = p_175321_2_;
            case 155 -> field_175336_F.useWaterLakes = p_175321_2_;
            case 156 -> field_175336_F.useLavaLakes = p_175321_2_;
            case 161 -> field_175336_F.useLavaOceans = p_175321_2_;
    ...
    private void func_175331_h() throws IOException {
        switch (field_175339_B) {
            case 300 -> actionPerformed((GuiListButton) field_175349_r.func_178061_c(300));
            case 304 -> func_175326_g();
        }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (field_175339_B == 0) {
            switch (keyCode) {
                case 200 -> func_175327_a(1.0F);
                case 208 -> func_175327_a(-1.0F);
                default -> field_175349_r.func_178062_a(typedChar, keyCode);
            }
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawRect(0, 0, width, 33, Integer.MIN_VALUE);
        drawGradientRect(0, 33, width, 45, Integer.MIN_VALUE, 0);
        drawRect(0, height, width, height - 36, Integer.MIN_VALUE);
        drawGradientRect(0, height - 44, width, height - 36, 0, Integer.MIN_VALUE);
