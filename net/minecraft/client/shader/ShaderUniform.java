...
public class ShaderUniform {
    ...
    private void uploadInt() {
        switch (uniformType) {
            case 0 -> OpenGlHelper.glUniform1(uniformLocation, uniformIntBuffer);
            case 1 -> OpenGlHelper.glUniform2(uniformLocation, uniformIntBuffer);
            case 2 -> OpenGlHelper.glUniform3(uniformLocation, uniformIntBuffer);
            case 3 -> OpenGlHelper.glUniform4(uniformLocation, uniformIntBuffer);
            default ->
    ...
    private void uploadFloat() {
        switch (uniformType) {
            case 4 -> OpenGlHelper.glUniform1(uniformLocation, uniformFloatBuffer);
            case 5 -> OpenGlHelper.glUniform2(uniformLocation, uniformFloatBuffer);
            case 6 -> OpenGlHelper.glUniform3(uniformLocation, uniformFloatBuffer);
            case 7 -> OpenGlHelper.glUniform4(uniformLocation, uniformFloatBuffer);
            default ->
                    logger.warn("Uniform.upload called, but count value (" + uniformCount + ") is " + "not in the range of 1 to 4. Ignoring.");
        }
    }
    ...
    private void uploadFloatMatrix() {
        switch (uniformType) {
            case 8 -> OpenGlHelper.glUniformMatrix2(uniformLocation, true, uniformFloatBuffer);
            case 9 -> OpenGlHelper.glUniformMatrix3(uniformLocation, true, uniformFloatBuffer);
            case 10 -> OpenGlHelper.glUniformMatrix4(uniformLocation, true, uniformFloatBuffer);
        }
    }
}
