...
public enum ModelRotation implements IModelState, ITransformation {
    ...
    public net.minecraft.util.Matrix4f getMatrix() {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (net.minecraft.util.Matrix4f) Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[]{this}) : (net.minecraft.util.Matrix4f) (new Matrix4f(getMatrix4d()));
    }
