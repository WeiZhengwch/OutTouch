...
public class ModelHorse extends ModelBase {
    ...
    public ModelHorse() {
        ...
        setBoxRotation(muleLeftChest, 0.0F, ((float) Math.PI / 2.0F), 0.0F);
        ...
        setBoxRotation(muleRightChest, 0.0F, ((float) Math.PI / 2.0F), 0.0F);
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        head.rotateAngleX = f6 * (0.2617994F + f4) + f5 * 2.18166F + (1.0F - Math.max(f6, f5)) * head.rotateAngleX;
        head.rotateAngleY = f6 * f3 / (180.0F / (float) Math.PI) + (1.0F - Math.max(f6, f5)) * head.rotateAngleY;
        ...
        body.rotateAngleX = f6 * -45.0F / (180.0F / (float) Math.PI) + f7 * body.rotateAngleX;
        ...
        backLeftShin.rotationPointY = backLeftLeg.rotationPointY + MathHelper.sin(((float) Math.PI / 2.0F) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
        backLeftShin.rotationPointZ = backLeftLeg.rotationPointZ + MathHelper.cos(((float) Math.PI * 3.0F / 2.0F) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
        backRightShin.rotationPointY = backRightLeg.rotationPointY + MathHelper.sin(((float) Math.PI / 2.0F) + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
        backRightShin.rotationPointZ = backRightLeg.rotationPointZ + MathHelper.cos(((float) Math.PI * 3.0F / 2.0F) + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
        float f17 = (-1.0471976F + f16) * f6 + f11 * f7;
        float f18 = (-1.0471976F + -f16) * f6 + -f11 * f7;
        frontLeftShin.rotationPointY = frontLeftLeg.rotationPointY + MathHelper.sin(((float) Math.PI / 2.0F) + f17) * 7.0F;
        frontLeftShin.rotationPointZ = frontLeftLeg.rotationPointZ + MathHelper.cos(((float) Math.PI * 3.0F / 2.0F) + f17) * 7.0F;
        frontRightShin.rotationPointY = frontRightLeg.rotationPointY + MathHelper.sin(((float) Math.PI / 2.0F) + f18) * 7.0F;
        frontRightShin.rotationPointZ = frontRightLeg.rotationPointZ + MathHelper.cos(((float) Math.PI * 3.0F / 2.0F) + f18) * 7.0F;
        ...
        frontLeftShin.rotateAngleX = (frontLeftLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F + f16 * 0.2F)) * f6 + (f11 + Math.max(0.0F, f10 * 0.5F * p_78086_3_)) * f7;
        frontLeftHoof.rotateAngleX = frontLeftShin.rotateAngleX;
        frontRightLeg.rotateAngleX = f18;
        frontRightShin.rotateAngleX = (frontRightLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F - f16 * 0.2F)) * f6 + (-f11 + Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
