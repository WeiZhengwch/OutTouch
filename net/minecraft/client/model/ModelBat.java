...
public class ModelBat extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        if (((EntityBat) entityIn).getIsBatHanging()) {
            ...
            batHead.rotateAngleX = headPitch / (180.0F / (float) Math.PI);
            batHead.rotateAngleY = (float) Math.PI - netHeadYaw / (180.0F / (float) Math.PI);
            ...
            batRightWing.rotateAngleY = -((float) Math.PI * 2.0F / 5.0F);
            ...
            batHead.rotateAngleX = headPitch / (180.0F / (float) Math.PI);
            batHead.rotateAngleY = netHeadYaw / (180.0F / (float) Math.PI);
            ...
            batBody.rotateAngleX = ((float) Math.PI / 4.0F) + MathHelper.cos(ageInTicks * 0.1F) * 0.15F;
