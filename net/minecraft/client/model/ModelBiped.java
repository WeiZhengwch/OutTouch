...
public class ModelBiped extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (isRiding) {
            ...
            bipedRightLeg.rotateAngleX = -((float) Math.PI * 2.0F / 5.0F);
            bipedLeftLeg.rotateAngleX = -((float) Math.PI * 2.0F / 5.0F);
            bipedRightLeg.rotateAngleY = ((float) Math.PI / 10.0F);
            bipedLeftLeg.rotateAngleY = -((float) Math.PI / 10.0F);
        }

        if (heldItemLeft != 0) {
            bipedLeftArm.rotateAngleX = bipedLeftArm.rotateAngleX * 0.5F - ((float) Math.PI / 10.0F) * (float) heldItemLeft;
        }
        ...
        switch (heldItemRight) {
            case 0, 2, 1 ->
                    bipedRightArm.rotateAngleX = bipedRightArm.rotateAngleX * 0.5F - ((float) Math.PI / 10.0F) * (float) heldItemRight;
            case 3 -> {
                bipedRightArm.rotateAngleX = bipedRightArm.rotateAngleX * 0.5F - ((float) Math.PI / 10.0F) * (float) heldItemRight;
        ...
        if (aimedBow) {
            ...
            bipedRightArm.rotateAngleX = -((float) Math.PI / 2.0F) + bipedHead.rotateAngleX;
            bipedLeftArm.rotateAngleX = -((float) Math.PI / 2.0F) + bipedHead.rotateAngleX;
