...
public class CustomItemProperties {
    ...
    public CustomItemProperties(Properties props, String path) {
        ...
        texture = parseTexture(props.getProperty("texture"), props.getProperty("tile"), props.getProperty("source"), path, basePath, type, mapTextures, flag);
    ...
    public void updateIcons(TextureMap textureMap) {
        if (texture != null) {
            ...
            if (type == 1) {
                ...
                sprite = textureMap.registerSprite(resourcelocation);
            }
        }
