        ...
        switch (vertAxis) {
            case 0:
                if (side == 1) {
                    ...
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.north(), 1, icon, metadata);
                } else if (side == 0) {
                    flag = isNeighbour(cp, blockAccess, blockState, blockPos.north(), 0, icon, metadata);
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.south(), 0, icon, metadata);
                } else {
                    flag = isNeighbour(cp, blockAccess, blockState, blockPos.down(), side, icon, metadata);
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.up(), side, icon, metadata);
                }
            ...
            case 1:
                if (side == 3) {
                    ...
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.up(), 3, icon, metadata);
                } else if (side == 2) {
                    flag = isNeighbour(cp, blockAccess, blockState, blockPos.up(), 2, icon, metadata);
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.down(), 2, icon, metadata);
                } else {
                    flag = isNeighbour(cp, blockAccess, blockState, blockPos.south(), side, icon, metadata);
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.north(), side, icon, metadata);
                }
            ...
            case 2:
                if (side == 5) {
                    ...
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.down(), 5, icon, metadata);
                } else if (side == 4) {
                    flag = isNeighbour(cp, blockAccess, blockState, blockPos.down(), 4, icon, metadata);
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.up(), 4, icon, metadata);
                } else {
                    flag = isNeighbour(cp, blockAccess, blockState, blockPos.west(), side, icon, metadata);
                    flag1 = isNeighbour(cp, blockAccess, blockState, blockPos.east(), side, icon, metadata);
                }
