        ...
        if (indexNames1 == null || index1 >= 0 && index1 <= indexNames1.length) {
            if (indexNames2 == null || index2 >= 0 && index2 <= indexNames2.length) {
                switch (this) {
                    ...
                    default:
                        if (uniform instanceof ShaderUniform1f) {
                            return ((ShaderUniform1f) uniform).getValue();
                        } else if (uniform instanceof ShaderUniform1i) {
                            return (float) ((ShaderUniform1i) uniform).getValue();
                        } else if (uniform instanceof ShaderUniform2i) {
                            return (float) ((ShaderUniform2i) uniform).getValue()[index1];
                        } else if (uniform instanceof ShaderUniform2f) {
                            return ((ShaderUniform2f) uniform).getValue()[index1];
                        } else if (uniform instanceof ShaderUniform3f) {
                            return ((ShaderUniform3f) uniform).getValue()[index1];
                        } else if (uniform instanceof ShaderUniform4f) {
                            return ((ShaderUniform4f) uniform).getValue()[index1];
                        } else if (uniform instanceof ShaderUniformM4) {
                            return ((ShaderUniformM4) uniform).getValue(index1, index2);
                        } else {
