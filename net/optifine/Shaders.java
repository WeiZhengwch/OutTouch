...
public class Shaders {
    ...
    private static void setupFrameBuffer() {
        ...
        for (int k = 0; k < usedColorBuffers; ++k) {
            ...
            GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, gbuffersFormat[k], renderWidth, renderHeight, 0, getPixelFormat(gbuffersFormat[k]), GL12.GL_UNSIGNED_INT_8_8_8_8_REV, (FloatBuffer) null);
        ...
        for (int l = 0; l < usedColorBuffers; ++l) {
            ...
            GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR);
            GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL11.GL_LINEAR);
            GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, gbuffersFormat[l], renderWidth, renderHeight, 0, getPixelFormat(gbuffersFormat[l]), GL12.GL_UNSIGNED_INT_8_8_8_8_REV, (FloatBuffer) null);
            checkGLError("FT ca");
        }
        ...
        if (i1 == 36058) {
            ...
            for (int j = 0; j < usedColorBuffers; ++j) {
                ...
                GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, renderWidth, renderHeight, 0, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV, (FloatBuffer) null);
    ...
    private static void setupShadowFrameBuffer() {
        if (usedShadowDepthBuffers != 0) {
            ...
            for (int k = 0; k < usedShadowColorBuffers; ++k) {
                ...
                GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, shadowMapWidth, shadowMapHeight, 0, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV, (FloatBuffer) null);
